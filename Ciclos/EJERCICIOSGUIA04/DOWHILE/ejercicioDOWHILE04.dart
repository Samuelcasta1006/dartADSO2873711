...
void main() {
// SAMUEL CASTAÑO CARDONA - EJE DOWHILE 04
...
El programa debe preguntar si se desea continuar ingresando datos.
  */
  ...
  int primaria = 0,
      secundaria = 0,
      carreraTecnica = 0,
      estudProfesionales = 0,
      estudPosgrado = 0;
  double porcenPrimaria,
      porcenSecundaria,
      porcentecnico,
      porcenProfesional,
      porcenPosgrado;
  ...
  do {
    print(
        "Ingrese el tipo de estudio de la persona (primeria/secundaria/tecnico/profesional/posgrado ${contador + 1}");
    tipoEstudio = stdin.readLineSync();
    while (tipoEstudio != "primaria" &&
