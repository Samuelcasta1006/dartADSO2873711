...
class Persona {
  ...
  void mostrarInformacion() {
    print(
        "La persona se llama ${nombre}, es de genero ${genero} y mide ${estatura}");
  }
}
...
void main(List<String> args) {
  ...
  print("*" * 67);
  Persona persona2 =
      Persona("Pedro", "Masculino", 1.75, DateTime(2005, 04, 18));
  persona2.saludar();
  ...
  Persona persona3 = Persona(
      nombrePersona3, generoPersona3, estaturaPersona3, DateTime(1995, 01, 25));
  persona3.saludar();
