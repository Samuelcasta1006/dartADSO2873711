...
//ENTRADA
  ...
  if (salario >= 800000) {
    ...
    cuotas = ((valorCasa * 0.85) /(10*12)); //12 meses * 10 años, el 0.85 corresponde al % restante del vlor casa
    print(
    ...
    cuotas = ((valorCasa * 0.7) / (7 * 12)); //12 meses * 7 años, el 0.85 corresponde al % restante del vlor casa
    print("EL valor de la cuota inicial corresponde al 30%: $cuotaInicial y una cuota mensual de $cuotas durante 7 años");
  }
